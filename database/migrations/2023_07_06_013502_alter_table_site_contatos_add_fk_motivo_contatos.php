...
class AlterTableSiteContatosAddFkMotivoContatos extends Migration
{
    ...
    public function up()
    {
        ...
        //DB::statement('update site_contatos set motivo_contatos_id = motivo_contato'); - Reproduziu
    ...
    public function down()
    {
        ...
        //DB::statement('update site_contatos set motivo_contato = motivo_contatos_id'); --Reproduziu
